...
VALUES
(1, 'E001', 'Nguyen Van A', 'ACTIVE'),
(2, 'E002', 'Tran Thi B', 'ACTIVE');

-- 1 request pending
INSERT INTO profile_update_requests
(update_request_id, employee_id, request_date, status, reviewed_by, reviewed_at, reject_reason, comment)
VALUES
(1001, 1, '2025-03-01 09:00:00', 'PENDING', NULL, NULL, NULL, 'Change address and phone');

INSERT INTO profile_update_request_details
(detail_id, update_request_id, field_name, old_value, new_value)
VALUES
(1, 1001, 'ADDRESS', 'HCM - old', 'HCM - new'),
(2, 1001, 'PHONE_NUMBER', '0900000000', '0911111111');

-- bảng requests
INSERT INTO requests
(request_id, employee_id, request_type, created_at, status, approver_id, approved_at, reject_reason)
VALUES
(2001, 1, 'LEAVE',            '2025-02-01 10:00:00', 'APPROVED', 2, '2025-02-02 09:00:00', NULL),
(2002, 1, 'OT',               '2025-02-10 14:00:00', 'PENDING',  NULL, NULL, NULL),
(2003, 1, 'RESIGNATION',      '2025-02-15 09:30:00', 'REJECTED', 2, '2025-02-16 11:00:00', 'Reason too vague');

-- chi tiết LEAVE
INSERT INTO leave_requests
(request_id, leave_type, start_date, end_date, half_day, reason, handover_employee_id, attachment_path)
VALUES
(2001, 'ANNUAL', '2025-02-10', '2025-02-12', NULL, 'Family trip', NULL, NULL);

-- chi tiết OT
INSERT INTO overtime_requests
(request_id, ot_date, start_time, end_time, total_hours, ot_reason, project_name)
VALUES
(2002, '2025-02-11', '18:00:00', '21:00:00', 3.0, 'Release hotfix', 'HR System');

-- chi tiết Resignation
INSERT INTO resignation_requests
(request_id, proposed_last_working_date, resign_reason, has_completed_handover, hr_note)
VALUES
(2003, '2025-03-31', 'Personal reason', 0, NULL);
