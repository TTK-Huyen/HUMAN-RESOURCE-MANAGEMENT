...
const MOCK_DATA = [
  {
    ...
    status: 'pending',
    logs: [
      { time: '10/12/2023 08:30', action: 'Đã gửi yêu cầu', user: 'Nguyễn Văn A' },
      { time: '10/12/2023 09:00', action: 'Chờ quản lý duyệt', user: 'System' }
    ]
  },
  {
    id: 'REQ-2023-002',
    type: 'Làm thêm giờ (Overtime)',
    typeCode: 'overtime',
    employeeName: 'Trần Thị B',
    employeeId: 'NV024',
    avatar: 'https://ui-avatars.com/api/?name=Tran+Thi+B&background=random',
    department: 'Nhân sự (HR)',
    submittedDate: '11/12/2023',
    effectiveDate: '11/12/2023 (18:00 - 20:00)',
    status: 'approved',
    logs: [
      { time: '11/12/2023 10:00', action: 'Đã gửi yêu cầu', user: 'Trần Thị B' },
      { time: '11/12/2023 14:00', action: 'Đã duyệt', user: 'Manager' }
    ]
  },
  {
    id: 'REQ-2023-003',
    type: 'Công tác (Business Trip)',
    typeCode: 'trip',
    employeeName: 'Lê Văn C',
    employeeId: 'NV008',
    avatar: 'https://ui-avatars.com/api/?name=Le+Van+C&background=random',
    department: 'Kinh doanh (Sales)',
    submittedDate: '09/12/2023',
    effectiveDate: '15/12/2023',
    status: 'rejected',
    logs: [
        { time: '09/12/2023 09:00', action: 'Đã gửi yêu cầu', user: 'Lê Văn C' },
        { time: '10/12/2023 10:00', action: 'Đã từ chối: Sai quy trình', user: 'Manager' }
    ]
  },
  {
    id: 'REQ-2023-004',
    ...
    status: 'pending',
    logs: [
      { time: '11/12/2023 07:30', action: 'Đã gửi yêu cầu', user: 'Phạm Văn D' }
    ]
  },
];
